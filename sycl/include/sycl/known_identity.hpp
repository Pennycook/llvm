...
struct is_like : public std::is_same {}
...
using IsPlus =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::plus<T>> ||
                       std::is_like_v<BinaryOperation, sycl::plus<void>>>;

template <typename T, class BinaryOperation>
using IsMultiplies =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::multiplies<T>> ||
                       std::is_like_v<BinaryOperation, sycl::multiplies<void>>>;

template <typename T, class BinaryOperation>
using IsMinimum =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::minimum<T>> ||
                       std::is_like_v<BinaryOperation, sycl::minimum<void>>>;

template <typename T, class BinaryOperation>
using IsMaximum =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::maximum<T>> ||
                       std::is_like_v<BinaryOperation, sycl::maximum<void>>>;

template <typename T, class BinaryOperation>
using IsBitAND =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::bit_and<T>> ||
                       std::is_like_v<BinaryOperation, sycl::bit_and<void>>>;

template <typename T, class BinaryOperation>
using IsBitOR =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::bit_or<T>> ||
                       std::is_like_v<BinaryOperation, sycl::bit_or<void>>>;

template <typename T, class BinaryOperation>
using IsBitXOR =
    std::bool_constant<std::is_like_v<BinaryOperation, sycl::bit_xor<T>> ||
                       std::is_like_v<BinaryOperation, sycl::bit_xor<void>>>;

template <typename T, class BinaryOperation>
using IsLogicalAND = std::bool_constant<
    std::is_like_v<BinaryOperation, std::logical_and<T>> ||
    std::is_like_v<BinaryOperation, std::logical_and<void>> ||
    std::is_like_v<BinaryOperation, sycl::logical_and<T>> ||
    std::is_like_v<BinaryOperation, sycl::logical_and<void>>>;

template <typename T, class BinaryOperation>
using IsLogicalOR =
    std::bool_constant<std::is_like_v<BinaryOperation, std::logical_or<T>> ||
                       std::is_like_v<BinaryOperation, std::logical_or<void>> ||
                       std::is_like_v<BinaryOperation, sycl::logical_or<T>> ||
                       std::is_like_v<BinaryOperation, sycl::logical_or<void>>>;
